...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Insufficient permissions to fix class assignments';
  END IF;
...
-- Execute the function to fix the mismatched assignments
SELECT * FROM fix_student_class_assignments() 
LIMIT 50;