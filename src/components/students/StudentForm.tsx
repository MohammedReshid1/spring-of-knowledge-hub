  ...
  const submitMutation = useMutation({
    mutationFn: async (data: StudentFormData) => {
      ...
      if (student) {
        ...
        // For new students, we need to generate a student_id
        // The student_id will be auto-generated by the database trigger
        const insertPayload = {
          ...payload,
          student_id: '', // This will be overwritten by the database trigger
        };
