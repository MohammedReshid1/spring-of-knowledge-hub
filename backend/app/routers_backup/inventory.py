...
async def get_inventory_overview(
    ...
    assets_under_maintenance = await assets_collection.count_documents({"status": "under_maintenance"})
    
    # Supply statistics
    total_supplies = await supplies_collection.count_documents({"is_active": True})
    ...
    pending_maintenance = await maintenance_collection.count_documents({"status": "scheduled"})
